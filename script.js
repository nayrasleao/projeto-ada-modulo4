...
buttonCalc.addEventListener("click", function () {
  ...
  let pessoasBebem = parseInt(document.getElementById("pessoasBebem").value[0]);
  ...
  let paragrafoCarne = "<p> Carne: " + carne + " kg" + "</p>";

  if (paoDeAlho == 1) {
    var paragrafoPaoDeAlho =
      "<p> Pão de Alho: " + paoDeAlho + " pão de alho" + "</p>";
  } else {
    var paragrafoPaoDeAlho =
      "<p> Pão de Alho: " + paoDeAlho + " pães de alho" + "</p>";
  }
  ...
  if (refrigerante == 1) {
    var paragrafoRefrigerante =
      "<p> Refrigerante: " + refrigerante + " garrafa de 2 litros" + "</p>";
  } else {
    var paragrafoRefrigerante =
      "<p> Refrigerante: " + refrigerante + " garrafas de 2 litros" + "</p>";
  }
  ...
  let paragrafoCerveja =
    "<p> Cerveja: " + cerveja + " garrafas de 600 ml" + "</p>";

  let resultadoFinal = document.getElementById("result");

  if (pessoasBebem > adultos) {
    alert(
      "O número de pessoas que bebem deve ser menor ou igual ao número de adultos"
    );
...
function calculoCarne(adulto, criancas) {
  return adulto * 0.4 + criancas * 0.2;
